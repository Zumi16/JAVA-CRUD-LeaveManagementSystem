...
<head>
    ...
    <style>
        ...
        .text-center {
            color: #fff; /* Font color white for "Don't have an account?" */
        }
        .text-center a {
            color: #FFA8F4; /* Font color #8E44AD for "Register here" */
                ...
                <div class="card-body">
                    <form action="login" method="post">
                        <div class="form-group">
                            <i class='bx bx-user'></i> <!-- Boxicon for user -->
                            <input type="text" id="username" class="form-control" name="username" placeholder="Username" required>
                        </div>
                        <div class="form-group">
                            <i class='bx bx-lock-alt'></i> <!-- Boxicon for lock -->
